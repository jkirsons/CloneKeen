...
EXT_RAM_ATTR float sin_table[366];
EXT_RAM_ATTR float cos_table[366];
EXT_RAM_ATTR int light_undobuffer[MAP_MAXWIDTH][MAP_MAXHEIGHT], al_undo_x, al_undo_y;
EXT_RAM_ATTR char rayarea[MAP_MAXWIDTH][MAP_MAXHEIGHT]; char onlast;
